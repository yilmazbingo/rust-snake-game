...
eval("// we will load this to index.js so we can catch some error\n// now we need to change the entry point of the applicaton\n\n__webpack_require__.e(/*! import() */ \"index_ts\").then(__webpack_require__.bind(__webpack_require__, /*! ./index */ \"./index.ts\")).catch((e) => console.error(\"Error importing index.js :\", e));\n\n\n//# sourceURL=webpack://www/./bootstrap.js?");
